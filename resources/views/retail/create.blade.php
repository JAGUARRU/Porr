<x-app-layout title="เพิ่มร้านค้า">
    ...
    <div class="container">
        <div class="flex flex-row">
            ...
            <form action="{{ url('add-retail') }}" method="POST" class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 text-base font-semibold text-gray-600 dark:text-gray-400">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                    <div class="col-span-1">
                        <div class="">
                            ...
                            <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="retail_id" placeholder="ระบุรหัสร้านค้า" />
                        </div>
                        ...
                        <div class="mt-4">
                            <label for="text-gray-700 dark:text-gray-400">อำเภอ
                                <select class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" name="retail_district" >
                                    <option name="retail_district" value="">- เลือก -</option>
                                    <option name="retail_district" value="อำเภอเมือง">อำเภอเมือง</option>
                                    <option name="retail_district" value="อำเภอวังทอง">อำเภอวังทอง</option>
                                    <option name="retail_district" value="อำเภอพรหมพิราม">อำเภอพรหมพิราม</option>
                                    <option name="retail_district" value="อำเภอบางระกำ">อำเภอบางระกำ</option>
                                    <option name="retail_district" value="อำเภอบางกระทุ่ม">อำเภอบางกระทุ่ม</option>
                                    <option name="retail_district" value="อำเภอนครไทย">อำเภอนครไทย</option>
                                    <option name="retail_district" value="อำเภอวัดโบสถ์">อำเภอวัดโบสถ์</option>
                                    <option name="retail_district" value="อำเภอชาติตระการ">อำเภอชาติตระการ</option>
                                    <option name="retail_district" value="อำเภอเนินมะปราง">อำเภอเนินมะปราง</option>
                                </select>
                            </label>
                        </div>
                        ...
                        <div class="mt-4">
                            <label for="text-gray-700 dark:text-gray-400">ตำบล
                                <select class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray" name="retail_sub_district">
                    ...
                    <div class="col-span-1">
                        <div class="">
                            ...
                            <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="retail_postcode"/>
                        </div> 
