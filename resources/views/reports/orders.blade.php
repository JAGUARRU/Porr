<x-app-layout title="รายงานสรุปยอดสั่งซื้อรายเดือน">
    <div class="container grid px-6 mx-auto">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            รายงานสรุปยอดสั่งซื้อรายเดือน
        </h2>

        <form action="{{ route('reports.orders') }}" method="GET" class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 text-base font-semibold text-gray-600 dark:text-gray-400">
            @csrf
        ...
        <div class="w-full overflow-x-auto mb-12">
            ...
            <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                ตารางรายงานสรุปยอดสั่งซื้อรายเดือน
            </h2>
            ...
            <table class="w-full whitespace-no-wrap mb-12">
                <thead class="text-center">
                    <tr
                        ...
                        <th class="px-4 py-3 text-right">ยอดออเดอร์</th>
                    </tr>
                </thead>
