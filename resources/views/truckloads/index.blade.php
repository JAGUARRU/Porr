                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div><span>เบอร์โทรศัพท์:</span> {{ $order->retail->retail_phone }}</div>
                                <div><span>ช่องทางติดต่ออื่น:</span> {{ $order->retail->retail_contact }}</div>
                            </td>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    <a href="{{ url('truckloads/order/'.$order->id) }}" class="btn btn-primary btn-sm">
                                        <button
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        ...
                                        <a href="{{ url('truckloads/'.$truck->id.'/view') }}" class="btn btn-primary btn-sm">
                                            <button
                                                class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                                aria-label="View">
                                                จัดการ
